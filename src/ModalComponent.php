...
abstract class ModalComponent extends Component implements Contract
{
    ...
    protected static array $maxWidths = [
        'sm' => 'sm:max-w-sm',
        'md' => 'sm:max-w-fit',
        'lg' => 'sm:max-w-fit md:max-w-lg',
        'xl' => 'sm:max-w-fit md:max-w-xl',
        '2xl' => 'sm:max-w-fit md:max-w-xl lg:max-w-2xl',
        '3xl' => 'sm:max-w-fit md:max-w-xl lg:max-w-3xl',
        '4xl' => 'sm:max-w-fit md:max-w-xl lg:max-w-3xl xl:max-w-4xl',
        '5xl' => 'sm:max-w-fit md:max-w-xl lg:max-w-3xl xl:max-w-5xl',
        '6xl' => 'sm:max-w-fit md:max-w-xl lg:max-w-3xl xl:max-w-5xl 2xl:max-w-6xl',
        '7xl' => 'sm:max-w-fit md:max-w-xl lg:max-w-3xl xl:max-w-5xl 2xl:max-w-7xl',
    ];
